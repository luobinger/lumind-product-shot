...
样例图包：一款面向亚马逊美国站的儿童学步四轮平衡车（适用 10-24 个月，配备 135° 转向安全限位与全封闭静音轮），从一张产品实拍参考图端到端生成。
...
![详情页图包：7 张 1024x1536 竖版详情页，从居家首屏场景到 ASTM 安全质保收口](assets/showcase/04-detail-pack.jpg)

**产品多角度基准图 —— 6 视角物理特征锁定，1024x1024（流水线步骤 8）**

![产品多角度基准图：6 个规范物理视角锁定车架造型、比例与机械转向细节](assets/showcase/05-angle-sheet.jpg)

**请注意三件事，别只看图：** 
1. **核心转化帧 vs 支撑帧结构：** 上述 7 屏详情页中，真正承担核心转化冲击力的是 3 屏 —— 居家场景生活方式首屏承诺、普通童车 vs 本款童车的硬核痛点对比矩阵（直击父母最担心的“侧翻摔伤与车轮夹脚”痛点）、以及 135° 转向限位与低重心底盘机械解构；其余 4 屏为支撑与信任交付（全封闭 EVA 静音防刮木地板特写、10-24M 3阶段运动发育阶梯、15,000+ 美国家庭真实口碑证言卡、以及开箱即骑礼盒与 ASTM/CPSIA 安全质保认证）。
2. **多角度基准图（Step 8）锁定真实物理特征：** 当输入为真实产品实物参考图时，流水线优先执行产品角度图（Angle Sheet）锁模步骤，固定哑光鼠尾草绿管型、焦糖色鞍座把手与白色封闭轮，阻断 AI 后续出图时的车架与轮胎走样。
...
> [产品多角度基准图](assets/showcase/05-angle-sheet.jpg)

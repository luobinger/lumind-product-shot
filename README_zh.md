...
样例图包：一款亚马逊美国站的旅行颈枕，从一句产品简报端到端生成。

**主图图包 —— 5 张，同一套锁定的风格系统**

![主图图包：5 张共享同一风格锁的亚马逊商品图](assets/showcase/02-main-pack.jpg)

**详情页图包 —— 8 屏，每屏 1024x1536**

![详情页图包：8 张 1024x1536 竖版详情页，从首屏承诺到优惠收口](assets/showcase/04-detail-pack.jpg)

**请注意两件事，别只看图：** 上面 8 屏里真正承担转化的只有 3 屏 —— 首屏承诺、`Precision Jaw & Chin Support` 机制帧、以及左右对照的对比矩阵；其余 5 屏是支撑帧。同时，这套图包只是干净的视觉演示，**不是可直接投放的 listing**：图内每一项声称（`$49.99` 首发价、`30-Night Risk-Free Trial`、`100% Money Back Guarantee`、`TESTED & APPROVED` 徽章）都是 AI 生成的样例文案，未经真实商家核验。上架前请删除或替换这类声称 —— 见下文「局限性说明」。
